/datum/job/inquisitor
	...
	tutorial = "This is the week. All your lessons have led to this moment. Your students follow you with eager steps \
	and breathless anticipation. You’re to observe their hunt, and see if they can banish the evils haunting Psydonia, \
	and rise up to become true inquisitors. A guide to them, a monster to others. \
